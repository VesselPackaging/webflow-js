...
window.onload = function(e){
	...
	var clickArray = [
		...
		['locationTitle','ToggleBreadCrumb','a'],
		['locationTitleFr','ToggleBreadCrumb','a'],
		['serviceTitle','ToggleBreadCrumb','a'],
		['serviceTitleFr','ToggleBreadCrumb','a'],
		['labelServiceTitle','ToggleBreadCrumb','a'],
		['labelServiceTitleFr','ToggleBreadCrumb','a'],
		['subServiceTitle','ToggleBreadCrumb','a'],
		['subServiceTitleFr','ToggleBreadCrumb','a'],
