	...
	CGY : {
		...
		warehouse : {
				...
				"355ml STD" : {
					...
					labelType : {
						"Blank Cans" : {
							min : 10,
							max : 420,
							palletOptions : [["Half/Demie",10],["Tall/Grande",17],["Full/Complète",21]]
						},
						"Shrink Sleeve" : {
							min : 3,
							max : 840,
			...
			tray : {
				...
				max : 624,
				types : ["202 LOE REC Epoxy", "202 LOE 10 STATE USA BPANI", "202 SuperEnd REC Epoxy", "202 SuperEnd 10 STATE USA BPANI"]
			},
	...
	MISS : {
		...
		warehouse : {
			...
			tray: {
				...
				max : 624,
				types : ["200 B64 (250 ml Slim Cans Only)", "202 LOE REC Epoxy", "202 SuperEnd REC Epoxy", "202 LOE QC5 BPANI", "202 LOE QC20 BPANI"]
			},
			paktechTypes: ["4pk Black (788/box)", "6pk Black (510/box)", "4pk White (788/box)", "6pk White (510/box)"]
		},
		mobileCanning:{
			labelTypes : ["Silver Bullet / Vierge", "PSL/EAC", "Shrink Sleeve / Manchon rétractable", "Printed/Imprimée", "Cust. Provided/Fourni par le client"],
			canFormats : ["355ml STD", "473ml STD", "355ml Sleek", "250ml Slim"],
			trayTypes : ["Standard", "Sleek", "Slim (250ml)", "Waxed Std. (MTL only)"],
			paktechTypes: ["4pk Black (788/box)", "6pk Black (510/box)", "4pk White (788/box)", "6pk White (510/box)"]
		}
	}
}