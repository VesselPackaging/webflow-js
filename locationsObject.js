const locations = {
  CGY: {
    ...
    mobileCanning: {
      labelTypes: [
        "Silver Bullet / Vierge",
        "PSL/EAC",
        "Shrink Sleeve / Manchon rétractable",
        "Printed/Imprimée",
        "Cust. Provided/Fourni par le client",
      ],
      canFormats: ["355ml STD", "473ml STD", "355ml Sleek"],
  ...
  VAN: {
    ...
    warehouse: {
      ...
      tray: {
        ...
        max: 624,
        types: [
          "200 B64 (250 ml Slim Cans Only)",
          "202 LOE REC Epoxy",
          "202 LOE 10 STATE USA BPANI",
          "202 SuperEnd REC Epoxy",
          "202 SuperEnd 10 STATE USA BPANI",
        ],
      },
      paktechTypes: [
        "4pk Black (788/box)",
